...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_key.CreateAPIKeyDto"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-api_key_APIKeyWithTokenResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-api_key_APIKeyConfigResponse"
                        }
                    }
                }
            }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_key.UpdateAPIKeyDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/badge/{monitorId}/cert-exp": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Days before expiry to show as down",
                        "name": "downDays",
                        "in": "query"
                    }
                ],
        ...
        "/badge/{monitorId}/status": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Label when monitor is up",
                        "name": "upLabel",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Label when monitor is down",
                        "name": "downLabel",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Color when monitor is up",
                        "name": "upColor",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Color when monitor is down",
                        "name": "downColor",
                        "in": "query"
                    }
                ],
        ...
        "/badge/{monitorId}/uptime/{duration}": {
            "get": {
                "produces": [
                    "image/svg+xml"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Duration in hours (24, 720, 2160)",
                        "name": "duration",
                        "in": "path",
                        "required": true
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-array_incident_Model"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/incident.CreateDto"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-incident_Model"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/incident.UpdateDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/status-pages/slug/{slug}/incidents": {
            "get": {
                "produces": [
                    "application/json"
                ],
    ...
    "definitions": {
        ...
        "api_key.APIKeyWithTokenResponse": {
            "type": "object",
            "required": [
                "created_at",
                "display_key",
        ...
        "utils.ApiResponse-api_key_APIKeyConfigResponse": {
            "type": "object",
            "required": [
                "data",
                "message"
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/api_key.APIKeyConfigResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "utils.ApiResponse-api_key_APIKeyResponse": {
            "type": "object",
            "required": [
                "data",
                "message"
        ...
        "utils.ApiResponse-api_key_APIKeyWithTokenResponse": {
            "type": "object",
            "required": [
                "data",
                "message"
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/api_key.APIKeyWithTokenResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "utils.ApiResponse-array_api_key_APIKeyResponse": {
            "type": "object",
            "required": [
                "data",
                "message"
        ...
        "utils.ApiResponse-array_incident_Model": {
            "type": "object",
            "required": [
                "data",
                "message"
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/incident.Model"
                    }
                },
                "message": {
                    "type": "string"
        ...
        "utils.ApiResponse-incident_Model": {
            "type": "object",
            "required": [
                "data",
                "message"
